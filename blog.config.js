...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'BlinkLightslord', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '- 光影有术 - 行者无涯 -', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://blog.lightslord.top', // 网站地址
